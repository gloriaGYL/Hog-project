...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if player == 0: 
            ...
            score0_get = take_turn(num_rolls_0,score1,dice)
            score0 += score0_get
        else:
            num_rolls_1 = strategy1 (score1,score0)
            score1_get = take_turn(num_rolls_1,score0,dice)
            score1 += score1_get
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_roll <= 10:
        sc = aver(num_roll, dice)
        if sc > max_average:
            result_roll, max_average = num_roll, sc
        num_roll += 1
    return result_roll
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    bacon = 2 + abs((opponent_score % 10) - (opponent_score // 10))
    if bacon >= margin:
        return 0
    else:
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    bacon = 2 + abs((opponent_score % 10) - (opponent_score // 10)) 
    if opponent_score == 2 * (score + bacon) or bacon >= margin:
        return 0
    return num_rolls   # Replace this statement
    # END PROBLEM 11
